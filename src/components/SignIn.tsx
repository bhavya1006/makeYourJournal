    ...
    <div className="min-h-screen flex flex-col lg:flex-row relative">
      ...
      >
        <div className="w-full max-w-md">
          ...
          >
            <h1 className="mb-2 text-2xl sm:text-3xl">Welcome back</h1>
            <p className="text-muted-foreground mb-6 sm:mb-8 text-sm sm:text-base">Sign in to continue your productivity journey</p>
